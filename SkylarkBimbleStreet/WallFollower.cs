...
///     - ［未来予測ゴースト］：　［進行方向ゴースト］から見てさらに［親壁方向］に１フレーム進んだ先の位置。
/// 
/// 壁には種類がある。
/// 
///     - ［進行方向壁］：　［進行方向ゴースト］が食い込んだ壁。
///     - ［親壁］：　プレイヤーが沿っている壁。
///         - ［触壁］：　［入力方向ゴースト］が食い込んでいるとき。
///         - ［蹴壁］：　［入力方向ゴースト］が食い込んでいないとき。
/// 
/// いくつか状態がある。
/// 
///     - ［無反応］：　［進行方向壁］、［親壁］のいずれも無い。
///     - ［壁直前］：　［進行方向壁］が有り、［親壁］が無い。
///     - ［壁正面］：　［進行方向壁］、［触壁］のどちらも有る。
///     - ［壁沿い］：　［進行方向壁］が無く、［親壁］が有る。（※［親壁］に沿って移動している）
///         - ［壁沿い　＞　外角］：　さらに、［未来予測ゴースト］がどの壁にも食い込まない状態。
///     </pre>
/// </summary>
